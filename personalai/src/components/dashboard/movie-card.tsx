...
export default function MovieRecommenderCard({
  fullWidth,
}: MovieRecommenderCardProps) {
  ...
  return (
    <Card
      className={`h-full overflow-hidden backdrop-blur-sm bg-background/70 border-purple-500/20 shadow-lg ${
        fullWidth ? "w-full" : ""
      }`}
    >
      <CardHeader className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border-b border-red-500/20">
        ...
        <CardDescription>
          Get personalized movie recommendations based on your mood and genre
        </CardDescription>
      </CardHeader>
                ...
                >
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="text-sm text-muted-foreground space-y-1">
                      ...
                      <p>
                        <strong>Emotion:</strong> {movie.emotion}
                      </p>
                      <a
                        href={movie.link}
                        target="_blank"
      ...
      <CardFooter className="bg-red-500/5 border-t border-red-500/10 px-6 py-4">
        <p className="text-xs text-muted-foreground">
          Recommendations are based on your mood and selected genre
        </p>
      </CardFooter>
    </Card>
  );
